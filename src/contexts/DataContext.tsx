...
function dbSettingsToApp(dbSettings: any): AppSettings {
  return {
    ...
    quoteDisplayOptions: dbSettings.quote_display_options || dbSettings.default_display_options || DEFAULT_SETTINGS.defaultDisplayOptions,
    invoiceDisplayOptions: dbSettings.invoice_display_options || dbSettings.default_display_options || DEFAULT_SETTINGS.defaultDisplayOptions,
...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const updateSettings = async (updates: Partial<AppSettings>) => {
    await userSettingsService.update({
      ...
      quote_display_options: updates.quoteDisplayOptions as any,
      invoice_display_options: updates.invoiceDisplayOptions as any,
