...
COMMENT ON COLUMN user_settings.document_template IS 'Document template style: professional (Zoho-style, default), compact (ultra-minimal), classic (traditional)';
