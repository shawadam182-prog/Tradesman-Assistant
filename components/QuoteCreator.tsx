      ...
      <div className="p-4 space-y-6">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            {/* Selected Customer Details (editable overrides — won't change saved customer) */}
            {formData.customerId && (() => {
              const selectedCustomer = customers.find(c => c.id === formData.customerId);
              if (!selectedCustomer) return null;
              return (
                <div className="col-span-1 md:col-span-2 bg-slate-50 rounded-xl p-3 border border-slate-100 space-y-2">
                  <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Customer Details on this Document</label>
